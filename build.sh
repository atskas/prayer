...
# commands
g++ -ffreestanding -m32 -fno-stack-protector -fno-rtti -fno-exceptions -c kernel/shell/commands/echo.cpp -o build/shell/commands/echo.o # echo.cpp

# link everything
ld -m elf_i386 -n -T linker.ld -o build/kernel.elf build/gdt.o build/boot.o build/inter_asm.o build/exc_asm.o build/pag_asm.o build/kmain.o build/panic.o build/vga.o build/inter.o build/exc.o build/keyboard.o build/pag.o build/shell/shell.o build/shell/commands/echo.o
